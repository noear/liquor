...
public class Case21_2 {
    ...
    public void test_package() throws Exception {
        ...
        CodeSpec exp5 = new CodeSpec("Math.min(1,2)").imports(Math.class.getPackage());
        System.out.println(Exprs.eval(exp5));

        Scripts.eval(new CodeSpec("System.out.println(Math.min(11,21));").imports(Math.class.getPackage()));
